...
2. <div style="text-align: justify"> Manuscripts must be prepared in accordance with the LNAI (Lecture Notes in Artificial Intelligence) format. For the template and details on the LNCS style, see <a href="https://www.springer.com/gp/computer-science/lncs/conference-proceedings-guidelines">Springer's Author Instructions</a></div>
...
4. <div style="text-align: justify">Submissions are reviewed in a double-blind manner. i.e.</div>
    ...
    <ul style="list-style: lower-alpha; padding-left: 50px" start="1">
